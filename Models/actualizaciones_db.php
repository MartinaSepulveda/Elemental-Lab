<?php
    ...
    class Actualizaciones{
        ...
        public function actualizarClaveUsuario($claveUsuario, $idUsuario){
        ...
        public function actualizarClaveVeterinaria($claveVeterinaria, $nitVeterinaria){

            $objConexion = new Conexion;
            $conexion = $objConexion->get_conexion();
        
            // Consulta para actualizar la contraseña
            $actualizarClave = "UPDATE veterinaria SET claveVeterinaria = :claveVeterinaria WHERE nitVeterinaria = :nitVeterinaria";
            $result = $conexion->prepare($actualizarClave);
        ...
        public function actualizarPerfilVeterinaria($nitVeterinaria, $fotoVeterinaria, $nombreVeterinaria, $propietarioVeterinaria, $direccionVeterinaria, $correoVeterinaria, $telefonoVeterinaria){
            //creamos el objeto a partir de la clase conexion
            $objConexion = new Conexion(); 
            $conexion =$objConexion -> get_conexion();

            $editarPerfil = "UPDATE veterinaria SET fotoVeterinaria = :fotoVeterinaria, nombreVeterinaria = :nombreVeterinaria, propietarioVeterinaria = :propietarioVeterinaria, direccionVeterinaria = :direccionVeterinaria, correoVeterinaria = :correoVeterinaria, telefonoVeterinaria = :telefonoVeterinaria WHERE nitVeterinaria = :nitVeterinaria"; 

            // Preparamos lo necesario para ejecutar la consulta de SQL guardada en la anterior variable
            $result = $conexion -> prepare($editarPerfil);
            // Convertimos los argumentos $ en parametros : con bindParam
            $result -> bindParam(":nitVeterinaria", $nitVeterinaria);
            $result -> bindParam(":fotoVeterinaria", $fotoVeterinaria);

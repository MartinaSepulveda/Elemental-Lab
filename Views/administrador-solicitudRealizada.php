...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="solicitudes-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="administrador-solicitudRealizada.php" class="active">
  ...
  <script>
    ...
    const opciones = {
        nombreArchivo: 'Solicitudes_Realizadas.xlsx', // Nombre del archivo
        hojaNombre: 'Solicitudes Realizadas',                   // Nombre de la hoja

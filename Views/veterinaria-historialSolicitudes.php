...
document.getElementById('descargarExcel').addEventListener('click', function () {
    ...
    const opciones = {
        nombreArchivo: 'Histrorial_de_Solicitudes.xlsx', // Nombre del archivo
        hojaNombre: 'Historial Solicitudes',             // Nombre de la hoja
        excluirColumnas: []  // Asegúrate de que esta lista esté vacía si no deseas excluir columnas
    };

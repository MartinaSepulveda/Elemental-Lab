...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="iadministrador.php" class="logo d-flex align-items-center">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="usuarios-nav" class="nav-content collapse show " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="administrador-usuariosInactivos.php" class="active">
  ...
  <script>
    ...
    const opciones = {
        nombreArchivo: 'Usuarios_Inactivos.xlsx', // Nombre del archivo
        hojaNombre: 'Usuarios Inactivos',                   // Nombre de la hoja
